...
export enum ApiErrorCode {
  ...
  ACTIVE_LISTING_LIMIT_REACHED = 'ACTIVE_LISTING_LIMIT_REACHED',
  ...
  AMENITY_CODE_TAKEN = 'AMENITY_CODE_TAKEN',
  LEGAL_DRAFT_EXISTS = 'LEGAL_DRAFT_EXISTS',
  LEGAL_NOT_DRAFT = 'LEGAL_NOT_DRAFT',
  LEGAL_TRANSLATIONS_INCOMPLETE = 'LEGAL_TRANSLATIONS_INCOMPLETE',
