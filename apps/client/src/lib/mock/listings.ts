/**
 * Мок-листинги Avino (порт apps/claudeDesign/scripts/data.js).
 * Русский контент, районы Ташкента. Фото — те же Unsplash-плейсхолдеры:
 * хелпер `u(id, w)` повторяет функцию U(...) из прототипа.
 */
import type { Listing, ListingPhoto } from './types';

/** Генератор URL фото-плейсхолдера (Unsplash), как в прототипе. */
const u = (id: string, w = 900): string =>
  `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=${w}&q=70`;

/**
 * Подборки фото (Unsplash id) — у каждого листинга согласованный набор;
 * битые загрузки UI откатывает на тёплый плейсхолдер (PhotoImg).
 */
...
export const LISTINGS: Listing[] = [
  {
    ...
    agent: { name: 'Дилноза Каримова', pro: true, agency: 'Avino Pro · Estate Group', phone: '+998 90 123 45 67', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Boulevard Development', pro: true, agency: 'Avino Pro · Застройщик', phone: '+998 71 200 10 10', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Рустам Ахмедов', pro: false, agency: 'Частный собственник', phone: '+998 93 555 22 11', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Малика Юсупова', pro: true, agency: 'Avino Pro · Rent Service', phone: '+998 90 777 88 99', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Camila Estate', pro: true, agency: 'Avino Pro', phone: '+998 90 444 33 22', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Шерзод Набиев', pro: false, agency: 'Частный собственник', phone: '+998 97 123 00 55', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Nest One Sales', pro: true, agency: 'Avino Pro · Застройщик', phone: '+998 71 100 20 20', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Озода Рахимова', pro: false, agency: 'Частный собственник', phone: '+998 99 321 65 87', kind: 'owner' },
  ...
  },
  {
    ...
    agent: { name: 'Жасур Тошпулатов', pro: true, agency: 'Avino Pro · City Homes', phone: '+998 90 234 56 78', kind: 'owner' },
    createdAt: '2026-06-10T11:00:00Z',
  },
  {
    id: 'av-1010', tx: 'SALE', type: 'COMMERCIAL', promo: 'NORMAL',
    price: '320000', currency: 'USD', area: '140', floor: 1, totalFloors: 1, year: 2020,
    ...
    agent: { name: 'Commercial UZ', pro: true, agency: 'Avino Pro', phone: '+998 71 300 40 40', kind: 'owner' },
    createdAt: '2026-06-05T11:00:00Z',
  },
  {
    ...
    agent: { name: 'Green Park Rent', pro: true, agency: 'Avino Pro', phone: '+998 90 111 22 33', kind: 'owner' },
    createdAt: '2026-06-11T11:00:00Z',
  },
  {
    id: 'av-1012', tx: 'SALE', type: 'LAND', promo: 'NORMAL',
    price: '540000000', currency: 'UZS', area: '800',
    ...
    agent: { name: 'Бахтиёр Усманов', pro: false, agency: 'Частный собственник', phone: '+998 94 765 43 21', kind: 'owner' },
