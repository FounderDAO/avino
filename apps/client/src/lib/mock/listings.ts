...
export const LISTINGS: Listing[] = [
  {
    ...
    agent: { name: 'Дилноза Каримова', pro: true, agency: 'Avino Pro · Estate Group', phone: '+998 90 123 45 67' },
  ...
  },
  {
    ...
    agent: { name: 'Boulevard Development', pro: true, agency: 'Avino Pro · Застройщик', phone: '+998 71 200 10 10' },
  ...
  },
  {
    ...
    agent: { name: 'Рустам Ахмедов', pro: false, agency: 'Частный собственник', phone: '+998 93 555 22 11' },
  ...
  },
  {
    ...
    agent: { name: 'Малика Юсупова', pro: true, agency: 'Avino Pro · Rent Service', phone: '+998 90 777 88 99' },
  ...
  },
  {
    ...
    agent: { name: 'Camila Estate', pro: true, agency: 'Avino Pro', phone: '+998 90 444 33 22' },
  ...
  },
  {
    ...
    agent: { name: 'Шерзод Набиев', pro: false, agency: 'Частный собственник', phone: '+998 97 123 00 55' },
  ...
  },
  {
    ...
    agent: { name: 'Nest One Sales', pro: true, agency: 'Avino Pro · Застройщик', phone: '+998 71 100 20 20' },
  ...
  },
  {
    ...
    agent: { name: 'Озода Рахимова', pro: false, agency: 'Частный собственник', phone: '+998 99 321 65 87' },
  ...
  },
  {
    ...
    agent: { name: 'Жасур Тошпулатов', pro: true, agency: 'Avino Pro · City Homes', phone: '+998 90 234 56 78' },
    createdAt: '2026-06-10T11:00:00Z',
  },
  {
    ...
    agent: { name: 'Commercial UZ', pro: true, agency: 'Avino Pro', phone: '+998 71 300 40 40' },
    createdAt: '2026-06-05T11:00:00Z',
  },
  {
    ...
    agent: { name: 'Green Park Rent', pro: true, agency: 'Avino Pro', phone: '+998 90 111 22 33' },
    createdAt: '2026-06-11T11:00:00Z',
  },
  {
    ...
    agent: { name: 'Бахтиёр Усманов', pro: false, agency: 'Частный собственник', phone: '+998 94 765 43 21' },
